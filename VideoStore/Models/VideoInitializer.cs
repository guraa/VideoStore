...
namespace VideoStore.Models
{
    ...
    public class VideoInitializer : DropCreateDatabaseIfModelChanges<VideoContext>
    {
        ...
        {
            var localpath = System.AppContext.BaseDirectory;
            sPath = localpath + sPath;
            byte[] data = null;
        ...
        protected override void Seed(VideoContext context)
        {
            ...
            {
                new VideoModels{description="Star Wars: Episod I – Det mörka hotet är en amerikansk science fiction-film som hade biopremiär i USA 1999, skriven och regisserad av George Lucas", genre="Science fiction", price=205, title="Star Wars: Episod I – Det mörka hotet", Image = ReadFile("Star_Wars.jpg") },
                new VideoModels{description="Bad Santa är en amerikansk långfilm från 2003 i regi av Terry Zwigoff, med Billy Bob Thornton, Tony Cox, Brett Kelly och Lauren Graham i rollerna", genre="Komedi", price=99, title="Bad Santa", Image = ReadFile("badsanta.jpg")},
                ...
                new VideoModels{description="Elf är en tysk-amerikansk julinspirerad komedifilm från 2003, med Will Ferrell i huvudrollen. Regisserad av Jon Favreau", genre="Komedi", price=99, title="Elf", Image = ReadFile("elf.jpg")},
                ...
                new VideoModels{description="Polarexpressen är en amerikansk animerad långfilm i regi av Robert Zemeckis. Den hade allmän biopremiär i USA den 10 november 2004.", genre="Komedi", price=99, title="Polarexpressen", Image = ReadFile("polar.jpg")},
